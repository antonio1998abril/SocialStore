  ...
  const companyDetail = () =>{
    ...
    const productDetail =() =>{
        ...
        <React.Fragment>
            ...
            <Button variant="warning" type="submit" className="optionItemButton" onClick={() => addCart(info)}>
                <i><FontAwesomeIcon icon={faShoppingBag } style={{color: "black"}} inverse transform="shrink-2" size = '2x'  /></i>
                BUY
            </Button>
        </React.Fragment>
        )
